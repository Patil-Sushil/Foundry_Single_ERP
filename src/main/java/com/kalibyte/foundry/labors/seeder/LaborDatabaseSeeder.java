...
public class LaborDatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (laborerRepository.count() == 0) {
            ...
            // 1. Create Laborers
            LaborerResponse hourly1 = laborerService.createLaborer(LaborerRequest.builder()
                    .name("John Doe")
            ...
            LaborerResponse hourly2 = laborerService.createLaborer(LaborerRequest.builder()
                    .name("Jane Smith")
                    .wageType(WageType.HOURLY)
            ...
            LaborerResponse pieceRate1 = laborerService.createLaborer(LaborerRequest.builder()
                    .name("Bob Wilson")
            ...
            for (int i = 1; i <= 5; i++) {
                ...
                // Hourly workers
                attendanceService.logAttendance(AttendanceRequest.builder()
            ...
            advanceService.grantAdvance(AdvanceTransactionRequest.builder()
                    .laborerId(hourly1.getId())
            ...
            weeklyPayoutService.generateWeeklyPayout(WeeklyPayoutRequest.builder()
                    .laborerId(hourly1.getId())
