-------------------------------------------------------
-- V3__pattern_enquiry_schema.sql (UPDATED FINAL)
-------------------------------------------------------
...
CREATE INDEX idx_pattern_receipt_name ON pattern_receipt(name);
CREATE INDEX idx_pattern_receipt_inward ON pattern_receipt(inward_date);
